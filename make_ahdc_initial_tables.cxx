void make_ahdc_initial_tables(){
	...
	ahdc_t0 << "# inital params (t0, dt0, extra1, extra2, chi2ndf)" << endl;
	...
	ahdc_t2d << "# inital params (p0, p1, p2, p3, p4, p5, dp0, dp1, dp2, dp3, dp4, dp5, chi2ndf)" << endl;
	...
	cout << "mktbl calibration/alert/ahdc/time_offsets -r 576 sector=int layer=int component=int t0=double dt0=double extra1=double extra2=double chi2ndf=double #\'ALERT AHDC timing offset parameters\'" << endl;
